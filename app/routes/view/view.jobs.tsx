...
export default function AllJobs() {
  ...
  return (
    <div className="h-screen items-center justify-center">
      <div className="relative max-h-[calc(100vh-80px)] lg:w-4/5  grid grid-cols-1 gap-2 p-8 mx-auto lg:border-2 lg:border-slate-400 rounded-lg overflow-y-scroll lg:drop-shadow-xl lg:bg-slate-600/60">
